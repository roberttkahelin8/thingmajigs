...
If you want to support this mod directly (and if you think its worth your money), use this special donation link (choose between 3 options or name your own price): [Donation Link](https://www.paypal.com/donate?hosted_button_id=SFAF7K8G7L63S). Note that the mod will continue to be free, but now if you so desire you can donate.
