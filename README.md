...
If you want to support this mod and it's creator directly (and if you think its worth your money), use this special donation link (choose between 3 options or name your own price): [Donation Link](https://www.paypal.com/donate?hosted_button_id=SFAF7K8G7L63S). Note that the mod will continue to be free, but now if you so desire, you can donate. Note that on CF and MR that download count does nothing for me except put the mod on a higher rank than others (doesn't effect anything). Don't use social media too much to spread this mod out as that isn't fair for other mods just starting. Remember, all mods started out of absolutely nothing, and wouldn't exist if people didn't put many hours into them and care and attention to detail. Some of the money donated will always go to some helpers somewhere so that others get help (really you should do this without question). We don't support certain kinds of actions, and don't give money to "look good".
